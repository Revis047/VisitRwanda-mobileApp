...
export default function DestinationScreen(props) {
  ...
  return (
    <View className='bg-white flex-1'>
      ...
      <Image source={item.image} style={{width: wp(100) , height: wp(100)}}/>
    ...
    <SafeAreaView className='flex-row justify-between items-center w-full absolute '>
      ...
      {/* title & destination  & booking button */}
           ...
           <View className='flex-row justify-between mx-1'>
            ...
            <View className='flex-row space-x-2 items-start '>
                ...
                <View className='flex space-y-2'>
                    <Text style={{fontSize: wp(4.5)}}  className='font-bold  '>{item.duration}</Text>
                    <Text className='text-neutral-600 tracking-wide'>Duration</Text>
                </View>
            </View>

             <View className='flex-row space-x-2 items-start '>
                <MapPinIcon size={wp(7)} color='#be3131ff' />
                <View className='flex spce-y-2'>
                    <Text style={{fontSize: wp(4.5)}}  className='font-bold  '>{item.distance}</Text>
             ...
             <View className='flex-row space-x-2 items-start '>
                ...
                <View className='flex spce-y-2'>
                    <Text style={{fontSize: wp(4.5)}}  className='font-bold  '>{item.weather}</Text>
    ...
    <TouchableOpacity  style={{backgroundColor: 'green' ,height: wp(15), width: wp(50) }} className='mb-6 mx-auto flex justify-center items-center rounded-full'>
