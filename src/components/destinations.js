...
const DestinationCard = ({ item, navigation }) => {
    ...
    return(
        ...
        className='flex justify-end relative p-6 py-6 space-y-2 mb-5'>
            <Image 
            source={item.image}
            ...
            className='absolute'/>
                   ...
                   <LinearGradient
                        ...
                        <TouchableOpacity onPress={() => setIsFavorite(!isFavorite)} style={{backgroundColor: 'rgba(255,255,255,0.4)'}} className='absolute top-1 right-3 rounded-full p-3'>
